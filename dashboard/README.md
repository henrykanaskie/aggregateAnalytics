...
# every time
SITE_PASSWORD=whatever venv/bin/uvicorn dashboard.api.app:app --port 8017
# open http://localhost:8017 and enter the password
```

The whole site sits behind one password (`webauth/README.md`). Deployment,
scheduled pulls and the cache are in `DEPLOY.md` at the repo root.
